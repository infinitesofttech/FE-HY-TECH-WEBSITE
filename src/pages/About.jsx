            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <div className="space-y-4 text-sm text-gray-600 leading-relaxed">
                  ...
                  <p>
                    At HY-Tech Online Hub, situated conveniently in Rajmilan Complex near Old Jakatnaka in Dharampur, our experienced team provides thorough, face-to-face assistance. We verify every record before submitting it to official state and central government portals.
                  </p>
                  <p>
                ...
                <div className="space-y-3.5 text-xs">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">Shop No. 5, 1st Floor, Rajmilan Complex, Old Jakatnaka, Dharampur, Gujarat</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
